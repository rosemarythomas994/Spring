...
>$(function () {
    $("#studentGrid").jqGrid({
        ...
        datatype: "json",
        mtype: "POST",
        colNames: ['#', 'ID', 'Name', 'Department', 'DOB', 'DOA', 'Gender', 'Address', 'Actions'],        colModel: [
            { name: 'rn', index: 'rn', width: 30, align: 'center', sortable: false, hidden: true },
            { name: 'studentId', index: 'studentId', width: 60, align: 'center', key: true },
            ...
            { name: 'actions', index: 'actions', width: 100, sortable: false, align: 'center', formatter: function(cellvalue, options, rowObject) {
                return '<span class="action-links">' +
                       '[<a href="edit.action?student.studentId=' + rowObject.studentId + '">Edit</a>] ' +
    ...
    // Update grid data on form submission
        ...
        <div class="container mt-5 bg-light">
            <s:form id="searchForm" action="search" cssClass="row g-3 needs-validation" method="post" theme="simple" onsubmit="return validateForm(event)">
                ...
                <div class="mb-3">
                    <div class="row align-items-center">
                        <div class="col-md-3">
                            <label for="name" class="form-label text-md-end">Student Name:</label>
                        </div>
                        <div class="col-md-8">
                            <s:textfield name="student.name" id="name" placeholder="Enter Student Name" cssClass="form-control"/>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <s:textfield name="student.dob" id="dob" placeholder="mm/dd/yyyy" cssClass="form-control"/>
                        </div>
                    </div>
                </div>
                <div class="mb-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-8">
                            <s:textfield name="student.doa" id="doa" placeholder="mm/dd/yyyy" cssClass="form-control"/>
                        </div>
                    </div>
                </div> 
               <div class="mb-3">
