...
public class ServiceLocator {
    ...
    private Object getFacadeManager() {
        final String CONTEXT = "STUDENT";
        ClassPathXmlApplicationContext context;
        try {
            if (!contex.containsKey(CONTEXT)) {
                context = new ClassPathXmlApplicationContext("applicationContext.xml");
                contex.put(CONTEXT, context);
                logger.info("Initialized Spring context for key: {}", CONTEXT);
            }else {
            context = contex.get(CONTEXT);
        ...
        return context.getBean("facadeManagerBean");
    }
